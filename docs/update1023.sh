...
echo "This will update Namingo Registry from v1.0.22 to v1.0.23."
...
echo "Cloning v1.0.23 from the repository..."
git clone --branch v1.0.23 --single-branch https://github.com/getnamingo/registry /opt/registry1023
...
copy_files "/opt/registry1023/automation" "/opt/registry/automation"
copy_files "/opt/registry1023/cp" "/var/www/cp"
copy_files "/opt/registry1023/whois/web" "/var/www/whois"
copy_files "/opt/registry1023/das" "/opt/registry/das"
copy_files "/opt/registry1023/whois/port43" "/opt/registry/whois/port43"
copy_files "/opt/registry1023/rdap" "/opt/registry/rdap"
copy_files "/opt/registry1023/epp" "/opt/registry/epp"
copy_files "/opt/registry1023/docs" "/opt/registry/docs"
...
if [[ $? -eq 0 ]]; then
    echo "Services started successfully. Deleting /opt/registry1023..."
    rm -rf /opt/registry1023
else
    echo "There was an issue starting the services. /opt/registry1023 will not be deleted."
fi

echo "Upgrade to v1.0.23 completed successfully."