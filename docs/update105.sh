...
echo "This will update Namingo Registry from v1.0.4 to v1.0.5."
...
git clone --branch v1.0.5 --single-branch https://github.com/getnamingo/registry /opt/registry105
...
copy_files "/opt/registry105/automation" "/opt/registry/automation"
copy_files "/opt/registry105/cp" "/var/www/cp"
copy_files "/opt/registry105/whois/web" "/var/www/whois"
copy_files "/opt/registry105/das" "/opt/registry/das"
copy_files "/opt/registry105/whois/port43" "/opt/registry/whois/port43"
copy_files "/opt/registry105/rdap" "/opt/registry/rdap"
copy_files "/opt/registry105/epp" "/opt/registry/epp"
copy_files "/opt/registry105/docs" "/opt/registry/docs"
...
if [[ $? -eq 0 ]]; then
    echo "Services started successfully. Deleting /opt/registry105..."
    rm -rf /opt/registry105
else
    echo "There was an issue starting the services. /opt/registry105 will not be deleted."
fi

echo "Upgrade to v1.0.5 completed successfully."
