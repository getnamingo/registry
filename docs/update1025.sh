...
echo "This will update Namingo Registry from v1.0.24.1 to v1.0.25."
...
echo "Cloning v1.0.25 from the repository..."
git clone --branch v1.0.25 --single-branch https://github.com/getnamingo/registry /opt/registry1025
...
copy_files "/opt/registry1025/automation" "/opt/registry/automation"
copy_files "/opt/registry1025/cp" "/var/www/cp"
copy_files "/opt/registry1025/whois/web" "/var/www/whois"
copy_files "/opt/registry1025/das" "/opt/registry/das"
copy_files "/opt/registry1025/whois/port43" "/opt/registry/whois/port43"
copy_files "/opt/registry1025/rdap" "/opt/registry/rdap"
copy_files "/opt/registry1025/epp" "/opt/registry/epp"
copy_files "/opt/registry1025/docs" "/opt/registry/docs"
...
if [[ $? -eq 0 ]]; then
    echo "Services started successfully. Deleting /opt/registry1025..."
    rm -rf /opt/registry1025
else
    echo "There was an issue starting the services. /opt/registry1025 will not be deleted."
fi

echo "Upgrade to v1.0.25 completed successfully."