...
echo "This will update Namingo Registry from v1.0.24 to v1.0.24.1."
...
echo "Cloning v1.0.24.1 from the repository..."
git clone --branch v1.0.24.1 --single-branch https://github.com/getnamingo/registry /opt/registry1024
...
echo "Upgrade to v1.0.24.1 completed successfully."