...
To update, you must run the update scripts sequentially without skipping versions. For example, if you're on v1.0.28 and the latest is v1.0.30, first update to v1.0.29, then to v1.0.30.

- v1.0.29 to v1.0.30 - download and run the [update1030.sh](update1030.sh) script.
...
- v1.0.26 to v1.0.27 - download and run the [update1027.sh](update1027.sh) script.

- v1.0.25 to v1.0.26 - download and run the [update1026.sh](update1026.sh) script.

- v1.0.24.1 to v1.0.25 - download and run the [update1025.sh](update1025.sh) script.
...
- v1.0.22 to v1.0.23 - download and run the [update1023.sh](update1023.sh) script.
