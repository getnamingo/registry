...
echo "This will update Namingo Registry from v1.0.27 to v1.0.28."
...
echo "Cloning v1.0.28 from the repository..."
git clone --branch v1.0.28 --single-branch https://github.com/getnamingo/registry /opt/registry1028
...
copy_files "/opt/registry1028/automation" "/opt/registry/automation"
copy_files "/opt/registry1028/cp" "/var/www/cp"
copy_files "/opt/registry1028/whois/web" "/var/www/whois"
copy_files "/opt/registry1028/das" "/opt/registry/das"
copy_files "/opt/registry1028/whois/port43" "/opt/registry/whois/port43"
copy_files "/opt/registry1028/rdap" "/opt/registry/rdap"
copy_files "/opt/registry1028/epp" "/opt/registry/epp"
copy_files "/opt/registry1028/docs" "/opt/registry/docs"
...
if [[ $? -eq 0 ]]; then
    echo "Services started successfully. Deleting /opt/registry1028..."
    rm -rf /opt/registry1028
else
    echo "There was an issue starting the services. /opt/registry1028 will not be deleted."
fi

echo "Upgrade to v1.0.28 completed successfully."