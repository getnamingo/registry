...
echo "This will update Namingo Registry from v1.0.5 to v1.0.6."
...
git clone --branch v1.0.6 --single-branch https://github.com/getnamingo/registry /opt/registry106
...
copy_files "/opt/registry106/automation" "/opt/registry/automation"
copy_files "/opt/registry106/cp" "/var/www/cp"
copy_files "/opt/registry106/whois/web" "/var/www/whois"
copy_files "/opt/registry106/das" "/opt/registry/das"
copy_files "/opt/registry106/whois/port43" "/opt/registry/whois/port43"
copy_files "/opt/registry106/rdap" "/opt/registry/rdap"
copy_files "/opt/registry106/epp" "/opt/registry/epp"
copy_files "/opt/registry106/docs" "/opt/registry/docs"
...
if [[ $? -eq 0 ]]; then
    echo "Services started successfully. Deleting /opt/registry106..."
    rm -rf /opt/registry106
else
    echo "There was an issue starting the services. /opt/registry106 will not be deleted."
fi

echo "Upgrade to v1.0.6 completed successfully."
