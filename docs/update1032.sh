...
echo "This will update Namingo Registry from v1.0.31 to v1.0.32."
...
echo "Cloning v1.0.32 from the repository..."
git clone \
    --branch v1.0.32 \
    --single-branch \
    --depth 1 \
...
copy_files "/opt/registry1032/automation" "/opt/registry/automation"
copy_files "/opt/registry1032/cp" "/var/www/cp"
copy_files "/opt/registry1032/whois/web" "/var/www/whois"
[ -d "/opt/registry/das" ] && copy_files "/opt/registry1032/das" "/opt/registry/das"
[ -d "/opt/registry/whois/port43" ] && copy_files "/opt/registry1032/whois/port43" "/opt/registry/whois/port43"
copy_files "/opt/registry1032/rdap" "/opt/registry/rdap"
copy_files "/opt/registry1032/epp" "/opt/registry/epp"
copy_files "/opt/registry1032/docs" "/opt/registry/docs"
...
if [[ $? -eq 0 ]]; then
    echo "Services started successfully. Deleting /opt/registry1032..."
    rm -rf -- "$clone_dir"
else
    echo "There was an issue starting the services. /opt/registry1032 will not be deleted."
fi

echo "Upgrade to v1.0.32 completed successfully."